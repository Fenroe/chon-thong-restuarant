    ...
    return (
      <div ref={ref} className={`info-row ${visible ? "visible" : "hidden"}`}>
        <div className="info-row-image">
          <img
            src="https://d2tgvtaoa6ihgv.cloudfront.net/chonthong/shelves.jpg"
            alt=""
          />
        </div>
  ...
  if (mode === "hours") {
    return (
      <div ref={ref} className={`info-row ${visible ? "visible" : "hidden"}`}>
        <div className="info-row-image">
          <img
            src="https://d2tgvtaoa6ihgv.cloudfront.net/chonthong/front-of-store.jpg"
            alt=""
          />
        </div>
        <div className="info-text">
  ...
  if (mode === "contact") {
    return (
      <div ref={ref} className={`info-row ${visible ? "visible" : "hidden"}`}>
        <div className="info-row-image">
          <img
            src="https://d2tgvtaoa6ihgv.cloudfront.net/chonthong/drinks.jpg"
            alt=""
          />
        </div>
        <div className="info-text">
